// Code generated by 'ccgo -o bench.go bench.c -lmodernc.org/sqlite/lib -pkgname sqlite -export-typedefs=__unused -export-structs=__unused -export-enums=__unused -export-defines=__unused -export-externs=__unused -export-fields=__unused', DO NOT EDIT.
